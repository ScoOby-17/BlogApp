// =============================================================================
// Post.js — Defines the shape of a Blog Post in the database
// =============================================================================
// This file only defines WHAT a post looks like (fields, types, defaults).
// Each post has a title, content, cover image, category, an author (user),
// an array of likes (user IDs), and an array of comments (comment IDs).
// =============================================================================
